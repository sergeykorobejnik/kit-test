...
const PostsActionsBar: React.FC<PostsActionsBarProps> = ({onPostCreate, creationModalControls, onFilterChange}) => {
    ...
    const selectedFilter = useMemo(() => {
        return filterLabels
            .filter(
                value => filters.orderBy === value.filters.orderBy
                    && filters.direction === value.filters.direction
            )[0];
    }, [filters])
